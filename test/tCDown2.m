...
PROC tCDown2.Grind 4 4 0x00300001
FRAME
! PROCEDURE Grind(e0: blobptr; VAR buf: ARRAY OF CHAR);
!   pos := 0;
CONST 0
...
PROC tCDown2.Add 8 6 0x00608001
FRAME
! PROCEDURE Add(op: INTEGER; p, q: blobptr; val, used: INTEGER);
!   r := htable[val MOD HSIZE];
LDGW tCDown2.htable
...
PROC tCDown2.Combine 12 7 0x00018001
FRAME
! PROCEDURE Combine(r, s: INTEGER);
!   used := Bit.Or(r, s);
LDLW 16
...
PROC tCDown2.%main 0 4 0
!   GcDebug("gs");
CONST 3
GLOBAL tCDown2.%9
GLOBAL tCDown2.GcDebug
CALL 2
!   NEW(htable);
CONST 80000
GLOBAL tCDown2.%10
