...
PROC tGC207.Reverse 0 4 0x00100001
! PROCEDURE Reverse(a: ptr): ptr;
!   IF a = NIL THEN
LDLW 12
JNEQZ L3
...
PROC tGC207.Snoc 4 4 0x00110001
FRAME
! PROCEDURE Snoc(a: ptr; x: INTEGER): ptr;
!   NEW(r);
CONST 8
...
PROC tGC207.Sum 4 4 0x00100001
FRAME
! PROCEDURE Sum(a: ptr): INTEGER;
!   IF a = NIL THEN
LDLW 12
...
PRIMDEF tGC207.GcHeapSize gc_heap_size I

PROC tGC207.%main 0 4 0
!   a := NIL;
CONST 0
STGW tGC207.a
!   FOR n := 1 TO 1000 DO a := Snoc(a, n) END;
