...
PROC tCDown207.Grind 4 4 0x00300001
FRAME
! PROCEDURE Grind(e0: blobptr; VAR buf: ARRAY OF CHAR);
!   pos := 0;
CONST 0
...
PROC tCDown207.Combine 12 7 0x00018001
FRAME
! PROCEDURE Combine(r, s: INTEGER);
!   used := Bit.Or(r, s);
LDLW 16
...
PROC tCDown207.Search 4140 7 0x00200001
FRAME
! PROCEDURE Search(n: INTEGER; draw: ARRAY OF INTEGER);
!   ones[0] := 0; t := 1;
CONST 0
