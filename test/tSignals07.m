...
(*[[
!! (SYMFILE #tSignals07 0x00000301 #tSignals07.%main 1)
!! (CHKSUM 0x2996830d)
!! 
...
PROC tSignals07.MakeSig 4 5 0x00610001
! PROCEDURE MakeSig(op: CHAR; left, right: Sig; value: INTEGER);
!   IF signal[value] = NIL THEN
GLOBAL tSignals07.signal
LDLW 24
...
PROC tSignals07.OutName 0 5 0x00100001
! PROCEDURE OutName(p: Sig);
!   Out.Char('s'); Out.Int(p.id, 0)
CONST 115
ALIGNC
...
PROC tSignals07.OutArc 0 5 0x00300001
! PROCEDURE OutArc(p, q: Sig);
!   OutName(p); Out.String(" -> "); OutName(q); Out.Ln
LDLW 12
...
PROC tSignals07.Print 0 5 0x00100001
! PROCEDURE Print(p: Sig);
!   OutName(p); Out.String('[label="'); 
LDLW 12
GLOBAL tSignals07.OutName
...
PROC tSignals07.Mark 0 5 0x00100001
! PROCEDURE Mark(s: Sig);
!   IF (s # NIL) & ~s.marked THEN
LDLW 12
JEQZ L34
...
PROC tSignals07.PrintMarked 8 5 0
! PROCEDURE PrintMarked;
!   FOR i := 0 TO sp-1 DO
LDGW tSignals07.sp
DEC
