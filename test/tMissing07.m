...
(*[[
!! (SYMFILE #tMissing07 0x00000301 #tMissing07.%main 1)
!! (CHKSUM 0x01393d0f)
!! 
...
PROC tMissing07.Swap 4 4 0x00300001
! PROCEDURE Swap(VAR x, y: INTEGER);
!   t := x; x := y; y := t
LDLW 12
LOADW
...
PROC tMissing07.Bundala2 0 4 0
! PROCEDURE Bundala2(): INTEGER;
LABEL L24
!   WHILE a[a[n]] # a[n] DO
GLOBAL tMissing07.a
...
!   Permute(M);
CONST 1000
GLOBAL tMissing07.Permute
CALL 1
!   x := Missing();  
GLOBAL tMissing07.Missing
CALLW 0
STLW -4
!   Out.Int(x, 0); Out.Ln;
CONST 0
